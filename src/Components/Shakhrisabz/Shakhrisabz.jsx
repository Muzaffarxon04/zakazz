...
import img1 from "../../Assets/images/shahrisabz-photo-1.png";
import img2 from "../../Assets/images/shahrisabz-photo-2.png";
import img3 from "../../Assets/images/shahrisabz-photo-3.png";
import img4 from "../../Assets/images/shahrisabz-photo-4.png";
        ...
        <div className="container">
          <div className="navigatsiya">
            ...
            <Link href={"/department/andijan"}>
              <a className="contact__link">{h.footer.shakhrisabz.split(" ")[0] + cc}</a>
            </Link>
          </div>
