        ...
        <div className="container">
          ...
          <div className="about__service__info">
            ...
            <div className="about__service__tasks">
              <h3 className="tasks__title">{hb.heading}</h3>
              <ul className="tasks__list">
                <li className="tasks__item">{hb.tasks.one}</li>
                <li className="tasks__item">{hb.tasks.two}</li>
                <li className="tasks__item">{hb.tasks.three}</li>
                <li className="tasks__item">{hb.tasks.four}</li>
                <li className="tasks__item">{hb.tasks.five}</li>
                <li className="tasks__item">{hb.tasks.six}</li>
              </ul>
            </div>
          </div>
        </div>
