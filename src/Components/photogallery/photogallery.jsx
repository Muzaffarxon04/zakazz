...
const arr = [
  {
    id: 1,
    title:
      "Xavfli gewwwwwologik jarayonlarni kuzatish davlat xizmati! 2021 yil qish-bahor mavsumiga tayyorgarlik",
  ...
  },
  {
    id: 2,
    title:
      "Xavfli geoloefefrfrgik jarayonlarni kuzatish davlat xizmati! 2021 yil qish-bahor mavsumiga tayyorgarlik",
    desc: "Oʼzbekiston Respublikasi Xavfli geologik jarayonlarni kuzatish Davlat xizmati Oʼzbekiston Respublikasi Prezidentining 2007 yil 19 fevraldagi PQ-585 sonli qarori va Vazirlar Mahkamasining 2017 yil 13 noyabrdag...",
    link: "https://kun.uz",
  },
  {
    ...
    <>
      <section className="photogallery">
        <div className="container">
          ...
          <Swiper
            className="photogallery__slider"
            modules={[Navigation]}
            spaceBetween={30}
            slidesPerView={3}
            navigation={{
