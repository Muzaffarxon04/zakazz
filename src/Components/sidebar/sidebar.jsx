...
<ul className="sidebar__list">
    ...
    <li className="sidebar__item"><Link href="/"><a className="sidebar__link">{c.sub_list_one.charter}</a></Link></li>
    <li className="sidebar__item"><Link href="/stricture"><a className="sidebar__link">{c.sub_list_one.structure}</a></Link></li>
    <li className="sidebar__item"><Link href="/"><a className="sidebar__link">{c.sub_list_one.management}</a></Link></li>
    <li className="sidebar__item"><Link href="/"><a className="sidebar__link">{c.sub_list_one.open_data}</a></Link></li>
    <li className="sidebar__item"><Link href="/"><a className="sidebar__link">{c.sub_list_one.department}</a></Link></li>
</ul>
</section>
</>)
