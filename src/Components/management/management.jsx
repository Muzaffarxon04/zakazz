          ...
          <div className="management-wrapper">
            ...
            <ul className="management__list">
              ...
              <Accordion
                ...
                fax={m.card3.phone}
                email={m.card3.email}
                email2={m.card3.email2}
                day={m.card3.open_days}
                text={m.card3.data}
                text2={m.card3.data2}
                text3={m.card3.data33}
                text4={m.card3.data44}
                text5={m.card3.data5}
                text6={m.card3.data6}
                text7={m.card3.data7}
              />
              <Accordion
                ...
                fax={m.card4.phone}
                email={m.card4.email}
                email2={m.card4.email2}
                day={m.card4.open_days}
                text={m.card4.data}
                text2={m.card4.data2}
                text3={m.card4.data33}
                text4={m.card4.data43}
                text5={m.card4.data5}
                text6={m.card4.data6}
                text7={m.card4.data7}
              />
